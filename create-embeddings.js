...
const knowledgeChunks = [
  ...
  { id: "chunk-3", text: "Current Focus: Arabic Romanizer (live AI transliteration tool powered by Gemini 2.5 Flash with scholarly diacritical handling and context-aware rules). VeoCreator (AI video generation tool using Google Gemini’s Veo 3, coming soon). Experimenting with AI APIs and web automation workflows. Open to collaborations and freelance opportunities." },
  ...
  { id: "chunk-7", text: "Experience: Independent Developer — Raven Corp.Tech. 2024 — Present • Remote. Built and launched “Arabic Romanizer” (AI tool for Arabic → Roman transliteration powered by Gemini 2.5 Flash with scholarly rules and diacritical precision). Developing “VeoCreator” (AI video generator using Google Gemini’s Veo 3). Prototyping automation scripts and AI utilities using JavaScript, Python, and Node.js." },
  { id: "chunk-8", text: "Project - Arabic Romanizer: Live at https://ravencorp-tech.github.io/Arabic-Romanizer/. AI‑powered Arabic → Roman transliteration with sun/moon letter handling, shadda-aware output, and scholarly diacritical precision. Tags: JavaScript, AI, Web App." },
